...
<script type="text/javascript">
		function empdel(id){
			...
			location="${pageContext.request.contextPath}/dept_delete.action?deptno="+id;
			}else{
			return false;
			}
		}
		function empupdate(id){
		location="${pageContext.request.contextPath}/dept_updateUI.action?deptno="+id;
		}
</script>
</head>
<body>
					...
					<tr>
						...
						<td><div class="button-group">
								<a class="button border-main" href="javascript:void(0)"
									onclick="return empupdate(${dept.deptno})"><span
									class="icon-edit"></span> 修改</a> <a class="button border-red"
									href="javascript:void(0)"
									onclick="return empdel(${dept.deptno})"><span
