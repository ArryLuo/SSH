	...
	<div class="header bg-main">
		...
		<div class="head-l">
			<a class="button button-little bg-green" href="" target="_blank"><span
				...
				href="${pageContext.request.contextPath}/user_quit.action"><span
	...
	<div class="leftnav">
		...
		<ul style="display: block">
			<li><a href="info.html" target="right"><span
					class="icon-caret-right"></span>网站设置</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/user_pass.action?"
				target="right"><span class="icon-caret-right"></span>修改密码</a>
			</li>
			<li>
				<!--获取当前用户的id--> <a href="page.html" target="right"><span
					class="icon-caret-right"></span>单页管理</a>
			</li>
			<li><a href="adv.html" target="right"><span
					class="icon-caret-right"></span>首页轮播</a>
			</li>
			<li><a href="book.html" target="right"><span
					class="icon-caret-right"></span>留言管理</a>
			</li>
			<li><a href="column.html" target="right"><span
					class="icon-caret-right"></span>栏目管理</a>
			</li>
		</ul>
		<h2>
		...
		<ul>
			<li><a
				href="${pageContext.request.contextPath}/emp_queryAll.action"
				target="right"><span class="icon-caret-right"></span>查看员工</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/emp_addUI.action"
				target="right"><span class="icon-caret-right"></span>添加员工</a>
			</li>
		...
		<ul>
			<li><a
				href="${pageContext.request.contextPath}/dept_queryAll.action"
				target="right"><span class="icon-caret-right"></span>查看部门</a>
			</li>
			<li><a
				href="${pageContext.request.contextPath}/dept_addUI.action"
				target="right"><span class="icon-caret-right"></span>添加部门</a>
			</li>
			<li><a href="cate.html" target="right"><span
					class="icon-caret-right"></span>分类管理</a>
			</li>
